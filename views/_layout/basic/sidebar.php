            ...
            <div class="sidebar_userInfo">
                <div class="sidebar_userInfo_img">
                    <div class="userInfo_img_wrap">
                        ...
                        <img src="<?php echo element('layout_skin_url', $layout); ?>/../bootstrap/seum_img/preview/<?php echo html_escape($this->member->item('mem_id')); ?>_preview.png?v=<?php echo mt_rand(); ?> "alt="character_full">
                    </div>
