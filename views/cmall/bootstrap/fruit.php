                ...
                if(count($view['data']['list'])>0){
                    foreach($view['data']['list'] as $k=>$v){
                        ...
                        <div style="border-top:solid 1px black; padding:20px;">
                            ...
                            <div style="padding:5px;">유형 : <?php if($v['fru_fruit'] > 0){ echo '획득'; } else { echo '차감'; } ?> </div>
                            <div style="padding:5px;">내용 : <?php echo $v['log_txt'];?></div>
                            <div style="padding:5px;">열매내역 : <?php echo $v['fru_fruit'];?></div>
                            <div style="padding:5px;">잔여열매 : <?php echo $v['fru_now_fruit'];?></div>
                        </div>
                        <?php
                    }
                }else{
