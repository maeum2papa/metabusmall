	...
	<div class="board">
		...
		<div class="row mb20">
			...
			<div class="board_name_box">
				<a class="selected" href=""><?php echo html_escape(element('board_name', element('board', element('list', $view)))); ?></a>
				<!-- <a href="">기업 공지사항</a> -->
			</div>
			<!-- //asmo sh 231121 컬래버랜드 공지사항, 기업 공지사항 버튼 추가 -->
			...
			<table class="table table-hover">
				<thead>
					<tr>
						...
						<?php if (element('is_admin', $view)) { ?><th style="width : 11%">기업명</th><?php } ?>
