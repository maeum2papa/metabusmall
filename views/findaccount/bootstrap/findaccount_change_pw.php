		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				?>
					...
					<!-- asmo sh 231114 텍스트 "회원님의 패스워드를 변경합니다. 비밀번호는 4자리 이상이어야 합니다."로 변경  -->
					<p>회원님의 패스워드를 변경합니다. 비밀번호는 4자리 이상이어야 합니다.</p>
					<!-- //asmo sh 231114 텍스트 "회원님의 패스워드를 변경합니다. 비밀번호는 4자리 이상이어야 합니다."로 변경  -->
					<div class="form-group">
						<label class="col-lg-3 control-label">아이디</label>
						<div class="col-md-4 id"><?php echo element('mem_userid', $view); ?></div>
					</div>
					<div class="form-group">
