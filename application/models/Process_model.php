...
class Process_model extends CB_Model
{
    ...
    {
        $sql = "SELECT video_idx, video_name from cb_video where state = 'use' order by video_name ASC";
        $rs = $this->db->query($sql);
        $result = $rs->result_array();
    ...
    {
        $sql = "SELECT game_content_idx, game_content_name from cb_game_content order by game_content_name ASC";
        $rs = $this->db->query($sql);
        $result = $rs->result_array();
    ...
    {
        $sql = "select c.*, v.video_name, g.game_content_name from cb_curriculum as c
                 left join cb_video as v on v.video_idx = c.video_idx
                 left join cb_game_content as g on g.game_content_idx = c.game_content_idx
