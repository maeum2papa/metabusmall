...
//		$q = "select * from cb_zep_posco where seum_sno = 1";
//		$r = $this->db->query($q);
//		$mem_arr = $r->result_array(); 
//		//print_r($mem_arr);
//		
//		$test_data = explode(',',$mem_arr[0][seum_result]);
//		
//		$test_data[4] = str_replace("cn=", "", $test_data[4]); 
//		
//		
//		//230612 자비스 통신결과를 로그로 남김
